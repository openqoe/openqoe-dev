...
type BaseEvent struct {
	EventType    string  `json:"event_type" binding:"required,oneof=manifestloadingstart playerready viewstart canplay canplaythrough playing pause seek waitstart stallstart stallend ended error quartile heartbeat qualitychangerequested qualitychangecompleted fpsdrop fragmentloaded bufferlevelchange bitratechange playbackratechange playbackvolumechange playbackdetached"`
